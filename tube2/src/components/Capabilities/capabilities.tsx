...
import CapabilityCards from '@/components/engineeringcards/CapabilityCards';
import ProcessCards from '@/components/engineeringcards/ProcessCards';
...
function Capabilities() {
    return (
        <>
            ...
            <h2 className={`uppercase mb-4 mt-8 font-bold !leading-tight text-Green dark:text-white text-[23px]`}>
